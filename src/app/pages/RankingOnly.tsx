...
export default function RankingOnly() {
  return (
    <div className="kcc-page kcc-ranking-page min-h-screen bg-gradient-to-br from-slate-100 to-slate-200 p-2 pb-[max(1rem,env(safe-area-inset-bottom))] sm:p-4 md:p-6">
